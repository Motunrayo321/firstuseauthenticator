...
from pytest_fix import test_first_use
...
async def test_new_min_pass_length(caplog, test_first_use):
	
	users = []
	auth = test_first_use
	password_length = auth.min_password_length
